iLens is a simple IOS project that uses mobilenetv2 model for detection of image and elements present in it. This project is soley for educational purpose.
